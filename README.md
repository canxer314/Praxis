...
./scripts/install.sh  --global              # macOS / Linux
```

### 卸载

```bash
.\scripts\uninstall.ps1 -Target D:\myproject  # 从指定项目移除
...
./scripts/uninstall.sh  --global --purge
```
...
**v1.0.0.1 · 873 tests · 71 files · TypeScript strict · typecheck clean · 5 Agent 运行时适配器就绪**
